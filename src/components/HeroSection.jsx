...
const HeroSection = () => {
  return (
    <div className="relative flex-1 flex flex-col md:flex-row">
      ...
      <motion.div
        className="w-full md:w-1/2 bg-primary p-6 md:p-12 flex items-center"
        initial={{ opacity: 0, x: -20 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.5, delay: 0.2 }}
      >
        <div className="max-w-xl mx-auto">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-background leading-tight">
            Event Management{" "}
            <span className="text-background">Simplified</span>
          </h1>
      ...
      <motion.div
        className="w-full md:w-1/2 bg-background p-6 md:p-12 flex items-center justify-center"
        initial={{ opacity: 0, x: 20 }}
        animate={{ opacity: 1, x: 0 }}
